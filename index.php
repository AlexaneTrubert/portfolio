    ...
    <div class="container hero-container">
        <picture class="hero-img">
            ...
            <img src="assets/images/home/desktop/image-homepage-hero.jpg"
                 srcset="assets/images/home/desktop/image-homepage-hero@2x.jpg 2x" alt="A mockup">
        </picture>
        <div class="hero-content">
            <h1 class="hero-title">Hey, I’m Alex Spencer and I love building beautiful websites</h1>
            <a class="hero-content-link btn" href="#">About me</a>
        </div>
    </div>
</section>
...
<section class="about">
    <div class="container about-container">
        <div class="about-content">
            ...
            <a class="about-link btn-secondary" href="#">Go to portfolio</a>
        </div>
        <picture class="about-image">
            ...
            <img src="assets/images/home/desktop/image-homepage-profile.jpg"
                 srcset="assets/images/home/desktop/image-homepage-profile@2x.jpg 2x" alt="A mockup">
        </picture>
    </div>
</section>
